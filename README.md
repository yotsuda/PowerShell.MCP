...
# Example output: C:\Users\YourName\Documents\PowerShell\Modules\PowerShell.MCP\1.2.2
```
...
```json
{
  "mcpServers": {
    "PowerShell": {
      "command": "C:\\Users\\YourName\\Documents\\PowerShell\\Modules\\PowerShell.MCP\\1.2.2\\bin\\PowerShell.MCP.Proxy.exe"
    }
  }
}
```
