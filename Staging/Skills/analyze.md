...
Analyze '$ARGUMENTS' using PowerShell.MCP and provide comprehensive insights with actionable recommendations.

If the 'HTML Generation Guidelines' prompt is not also selected, remind the user: 'For a visual HTML report, please also select the /html-guidelines skill.'
