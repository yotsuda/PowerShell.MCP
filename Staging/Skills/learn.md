...
Create a complete hands-on learning environment for $ARGUMENTS and guide step-by-step learning with emphasis on practical experience.

SETUP PHASE:
1. Confirm user's current knowledge and learning goals
2. Create a dedicated practice folder
3. Verify installation (guide installation if needed)
